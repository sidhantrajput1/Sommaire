  ...
  return (
    <section>
      <div className="flex flex-col items-center justify-center gap-6 text-center">
        {/* Badge */}
        <div className="relative p-[1px] overflow-hidden rounded-full bg-linear-to-r from-rose-200 via-rose-500 to-rose-800 animate-gradient-x group hover:bg-rose-200">
          <Badge
            variant="secondary"
